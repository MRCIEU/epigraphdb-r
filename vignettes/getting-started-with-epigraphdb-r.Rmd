...
## Part 2: Epidemilogical relationships analysis
...
In these example, we show how to extract [pre-computed MR results][6] for the specified exposure, outcome, or both, traits of interest. 
