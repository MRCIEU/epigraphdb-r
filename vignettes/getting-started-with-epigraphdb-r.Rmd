...
# This shows Uniprot and Ensembl protein IDs for the queried genes  
proteins
```
...
proteins_uniprot_ids <- c("P04637", "P04637") ## to fix - @Yi  - why can't I give it just a single item (giving x2 to overcome this)
...
# Get pathways names
pathway_df$pathway_reactome_id[[1]]
